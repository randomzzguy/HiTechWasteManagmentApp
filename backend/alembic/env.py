...
# Add backend/ to path so imports work when running alembic from backend/
...
from models.document import Certificate, Document, AgentEvent
...
from models.disruption import DisruptionLog, DisruptionJobImpact
